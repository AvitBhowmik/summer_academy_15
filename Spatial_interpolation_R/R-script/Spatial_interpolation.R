...
path <- "/Users/avitbhowmik/PhD/Teaching/Summer_Academy/2015/summer_academy_15/Spatial_interpolation_R/data"
setwd(path)
...
proj4string(Malawi_avg_upper_OC) <- proj4string(Malawi_border)
...
proj4string(Malawi_grid) <- proj4string(Malawi_border)
plot(Malawi_grid)
...
over_Malawi_Grid <- overlay(Kriged_Average_Soil_Organic_Carbon, Malawi_border)
inside_Malawi_Grid <- !is.na(over_Malawi_Grid)
